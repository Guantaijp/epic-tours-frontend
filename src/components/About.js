...
function About() {
  return (
    <div className="relative flex justify-center items-center">
      ...
      <div className="absolute top-12 right-0 w-1/2 text-m mt-10 pr-10">
        <p style={{ fontFamily: "Arial, sans-serif", color: "white", lineHeight: "2" }}>
      ...
      <div className="justify-center">
        <h2 className="absolute top-2 left-0 w-full text-center text-black font-bold text-xl z-10 mt-10">
          About Us
        </h2>
      </div>
    </div>
